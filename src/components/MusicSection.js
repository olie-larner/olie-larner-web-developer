	...
	return (
		...
		>
			<div className="w-full min-h-screen">
				<div className="w-10/12 pt-10 mx-auto ">
					<h3
						...
						className={classNames(
							'pb-16 text-7xl relative font-playfair text-gray-800 transition-all delay-300 duration-700',
							{
				...
				<div
					className={classNames(
						'flex flex-col w-10/12 mx-auto md:flex-row md:items-center relative transition-all delay-300 duration-700',
						{
				...
				>
					<div className="w-full mb-16 md:w-1/2 md:mb-0">
						<p className="w-full text-xl italic leading-10 text-gray-800 font-playfair md:w-2/3">
