      ...
      <div className="w-10/12 mx-auto flex flex-col items-center">
        <h3
          className={classNames(
            "text-7xl font-playfair text-center relative transition-all delay-300 duration-700",
        ...
        <p
          className={classNames(
            "font-playfair text-center w-11/12 md:w-1/2 py-10 text-xl md:text-2xl relative transition-all delay-500 duration-700",
            { "opacity-0 top-24": !contactVis },
            { "opacity-100 top-0": contactVis }
          )}
        >
        ...
        <a
          className={classNames(
            "italic text-2xl md:text-4xl font-playfair relative transition-all delay-700 duration-700",
            { "opacity-0 top-24": !contactVis },
            { "opacity-100 top-0": contactVis }
          )}
